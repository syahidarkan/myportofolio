...
- AI cenderung melanggar batasan tugas: Untuk efek "muncul satu per satu saat scroll", AI awalnya menyarankan JavaScript (IntersectionObserver). Saya tolak karena Tugas 1 minta HTML5 dan CSS3 murni, lalu saya arahkan memakai CSS Scroll-Driven Animations (animation-timeline: view()) dengan fallback @supports + @media (prefers-reduced-motion) supaya tetap rapi di browser yang belum mendukung.
- Breakpoint responsif AI tidak sesuai di perangkat asli: Saat saya buka di HP beneran, teks hero "SYAHID/ARKAN" menempel ke pinggir atas-bawah, tombol menu navbar hilang semua, dan foto About muncul setelah teks. AI tidak menangkap ini dari kode biasa. Saya evaluasi tiap breakpoint (900/768/600/400 px) satu per satu dan perbaiki: hero dikelompokkan di tengah, navbar dibuat membungkus dua baris agar semua link tampil, dan foto About dipindah ke atas teks dengan order: -1 di mobile.
- Kesalahan kecil yang lolos dari AI: Berkas video hero sempat salah kontainer (isi MP4 tapi berekstensi .webm) dan beberapa baris settings.py tidak persis di posisi yang diminta tutorial. Saya temukan ini lewat pemeriksaan manual baris per baris code terhadap Tutorial 0 dan Tutorial 01.

Kesimpulan yg saya dapat: AI berguna untuk mempercepat scaffolding dan iterasi, tapi tidak bisa dipercaya gitu aja untuk mematuhi batasan tugas, menilai selera desain, atau menguji tampilan di perangkat nyata. Bagian-bagian itu tetap harus saya kerjakan dan verifikasi sendiri.
